...
for Linux GNU or macOS on x86_64/aarch64. Repository builds use the fx submodule;
...
`libfx_core.a`; its ABI must match and its target must match Cargo's target.
